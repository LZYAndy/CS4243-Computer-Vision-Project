...
detpath = 'results/eval/{}.txt'
baseline_detpath = 'baseline/{}.txt'
...
for idx, classname in enumerate(classes) :
    rec, prec, ap = voc_eval(baseline_detpath, annopath, imagesetfile, classname,
                                            cachedir, ovthresh=0.05, use_07_metric=False)
    meanAP += ap
